...
/// <summary>
/// Handles the desturction of a mesh, in this case, the destruction of the enemy and the bullet into multiple parts, when the enemy is hit by a bullet
/// </summary>
...
public class MeshDestroyer : MonoBehaviour
{
    ...
    [SerializeField] int CutCascades = 6; // The number of parts created after the destruction of the mesh
    [SerializeField] float ExplodeForce = 6;
